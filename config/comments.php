...
return [
     ...
     */
    'permissions' => [
        'create-comment' => 'App\Http\Controllers\CommentPolicy@create',
        'delete-comment' => 'App\Http\Controllers\CommentPolicy@delete',
        'edit-comment' => 'App\Http\Controllers\CommentPolicy@update',
        'reply-to-comment' => 'App\Http\Controllers\CommentPolicy@reply',
    ],
    /**
