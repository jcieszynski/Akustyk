<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    ...
    <div class="navbar-collapse collapse w-100 order-1 order-md-0 dual-collapse2">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <a class="nav-item nav-link {{ (request()->is('music')) ? 'active' : '' }}" href="{{URL::to('music')}}">{{__('Music')}}</a>
            </li>
            <li class="nav-item">
            ...
            @if(Auth::check())
                <li class="nav-item">
                    <a class="nav-item nav-link {{ (request()->is('home')) ? 'active' : '' }}" href="{{URL::to('home')}}">{{__('Home')}}</a>
                </li>
            @endif
